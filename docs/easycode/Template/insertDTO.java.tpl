...
#set($className = $tool.append($tableInfo.name, "InsertDTO"))
...
##设置回调
#save($tool.append("/", $tool.firstLowerCase($tableInfo.name),"/service/dto"), "InsertDTO.java")
